...
def load_model(use_gpu=True, use_small=False, force_reload=False, model_type="text", device=None):
...
def preload_models(
    ...
    _ = load_model(
        model_type="text", use_gpu=text_use_gpu, use_small=text_use_small, force_reload=force_reload, device=device
    )
    _ = load_model(
        model_type="coarse",
    ...
    _ = load_model(
        model_type="fine", use_gpu=fine_use_gpu, use_small=fine_use_small, force_reload=force_reload, device=device
    )
    _ = load_codec_model(use_gpu=codec_use_gpu, force_reload=force_reload, device=device)
